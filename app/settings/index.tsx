      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        {renderGroup(t('settings.section.data'), [
          ...
          },
          {
            ...
            sub: 'Xuất file mã hoá chứa tất cả giao dịch, ví, mục tiêu, cài đặt',
          ...
          },
          {
            ...
            sub: 'Thay thế dữ liệu hiện tại bằng file backup',
          ...
          {
            icon: 'Database',
            label: 'Tối ưu cơ sở dữ liệu',
            sub: 'Nén file DB sau khi xoá nhiều giao dịch, giảm dung lượng app',
